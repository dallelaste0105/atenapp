...
class StudentChampionshipsViewScreen extends StatefulWidget {
  @override
  State<StudentChampionshipsViewScreen> createState() => _StudentChampionshipsViewScreenState();
}

class _StudentChampionshipsViewScreenState extends State<StudentChampionshipsViewScreen> {
  @override
                  ...
                  if (snapshot.hasData) {
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return StudentChampionshipCardWidget(
